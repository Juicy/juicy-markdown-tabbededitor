...
- Make a local clone of this repo: `git clone git@github.com:Juicy/juicy-markdown-tabbededitor.git`

In order to develop it locally we suggest to use [polyserve](https://npmjs.com/polyserve) tool to handle bower paths gently.

0. Go to the repo's directory: `cd juicy-markdown-tabbededitor`
...
4. Open the demo/preview: [http://localhost:8000/components/juicy-markdown-tabbededitor/](http://localhost:8000/components/juicy-markdown-tabbededitor/)
